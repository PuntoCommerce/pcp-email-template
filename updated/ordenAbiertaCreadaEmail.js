  ...
  `/recursos/bootstrap.min.css" rel="stylesheet">
      ...
      `.</p>
          ...
          <div style='color: #000000; font-size: 16px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left'>
            <p>Tu pedido ya está siendo procesado. Consulta el detalle del correo para ver los tiempos en que estará disponible o si lo prefieres en la sección de <a href="` +
