...
exports.lineasTransitoEmail = async function (order_id) {
  try {
    ...
    var htmlBody =
      ...
      <html lang='es'>
      <head>
        <title>Productos en tránsito actualizados</title>
        <link href="` +
  ...
  `/recursos/bootstrap.min.css" rel="stylesheet">
        ...
        <section id='main-content'>
          <header>
            <div style='color: #0B3196; font-size: 28px; font-weight: 500; letter-spacing: 0;'>
              <h1>Tu pedido está en tránsito</h1>                  
            </div>
          </header>
      ...
      `.</p>
          ...
          <div style='color: #000000; font-size: 16px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left'>
            <p>Tu pedido se encuentra en tránsito, Consulta el detalle del correo para ver los detalles del envío o si lo prefieres en la sección de <a href="` +
      process.env.STORE_LINK +
      `/myprofile">Mis Pedidos<a>.
            </p>
          </div>
