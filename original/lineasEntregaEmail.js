    ...
    const transporter = nodemailer.createTransport({
      ...
      <body>
        ...
        <div class='contenido1'>
              ...
              <p>Se han entregado articulos, Consulta el detalle del correo para ver los detalles del envío o si lo prefieres en la sección de <a href="`+ process.env.STORE_LINK +`/myprofile">Mis Pedidos<a>.</p>
