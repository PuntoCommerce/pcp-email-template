...
exports.lineasTransitoEmail = async function(order_id)
{
  try
  {
    var metodo_de_pago
    ...
    const transporter = nodemailer.createTransport({
      ...
      <body>
        ...
        <div class='contenido1'>
              ...
              <p>Tu pedido se encuentra en tránsito, Consulta el detalle del correo para ver los detalles del envío o si lo prefieres en la sección de <a href="`+ process.env.STORE_LINK +`/myprofile">Mis Pedidos<a>.</p>
      ...
      <div style='color: #000000; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify;'>
        ...
        const constProductoCompraFinalizada= await models.ProductoCompraFinalizada.findAll({
            ...
            attributes: ["pcf_prod_producto_id", "pcf_fecha_entrega", "pcf_cantidad_producto", "pcf_precio", "pcf_producto_compra_finalizada_id", "pcf_cantidad_entregada"]
        })

        const ConstCorreos = await models.Correos.findAll({
            where: {
                cor_pcf_cf_compra_finalizada_id: order_id,
                cor_cmm_tipo_correo: 1000191
            },
        })
        ...
        for (var x = 0; x < constProductoCompraFinalizada.length; x++) 
        {
            ...
            {
              if(constProductoCompraFinalizada[x].dataValues.pcf_producto_compra_finalizada_id == ConstCorreos[f].dataValues.cor_pcf_producto_compra_finalizada_id)
              {
                  ...
                  var cantidad = constProductoCompraFinalizada[x].dataValues.pcf_cantidad_entregada
    ...
    const mailOptions = {
      ...
      subject: 'Productos en transito actualizados',
      html: htmlBody
    };
