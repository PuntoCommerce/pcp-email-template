...
exports.ordenCreadaEmail = async function(order_id)
{
    ...
    console.log(transporter)
      ...
      <body>
        ...
        <div class='contenido1'>
              ...
              <p>El pedido #`+constCompraFinalizada.cf_compra_numero_orden+` está siendo revisado y recibirás una notificación una vez esté en proceso</p>

              <p>Puedes comprobar el estado de tu pedido en la seccion de <a href="`+ process.env.STORE_LINK +`/myprofile">Mis Pedidos<a>.</p>
