...
exports.correoEntregadoEmail = async function(order_id)
{
  ...
  try
  {
    ...
    const transporter = nodemailer.createTransport({
      ...
      var dateFinal
      var day = new Date()
      var nuevoDia = date_and_time.addHours(day, -5)
      ...
      <body>
        ...
        <div class='contenido1'>
              ...
              <p>Tu pedido fue entregado con éxito el día `+dateFinal+`.</p>
      ...
      <div style='color: #000000; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify;'>
        ...
        <div style='color: #40DF00; font-size: 18px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left; padding-bottom: 25px;'>
        <div class='contenido1'>
        </div>
            <p>`+constCompraFinalizada.cf_compra_numero_orden+`</p>

          </div>
          <p style="padding-bottom: 15px;">Gracias por tu preferencia</p>
      </div>
        ...
        <div style='color: #000000; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify;'>
          ...
          <div style='color: #000000; font-size: 16px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left'>
            ...
            <div style='color: #000000; font-size: 16px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left'>
              ...
              <div style='color: #000000; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify; padding-bottom: 30px'>
                      <div class='contenido'>
                      </div>
                      
                      <p>¿Deseas comprar más articulos?</p>
                ...
                <center>
                  <a href="`+process.env.STORE_LINK+`" target="_blank" style="
              ...
              <div style='border-bottom: 1px solid #000; padding-right: 15px; padding-top: 30px;'>
                <div style='color: #0B3196; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify;padding-top: 30px;'>
                <div class='contenidos'>
                </div>`;
      ...
      //         <center><img src='pagoe.png' / style='width: 600px;'></center>
      //         <div style='padding-top: 50px; color: #000000; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify;'>
      //         <div class='contenido'>
      //         </div>
      ...
      //         </div>
      //         <div style='color: #40DF00; font-size: 18px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left;'>
      //         <div class='contenido1'>
      //         </div>
      //           <p>`+constCompraFinalizada.cf_compra_numero_orden+`</p>
      //         <div style='color: #000; font-size: 16px; letter-spacing: 0; line-height: 20px; text-align: -webkit-left'>
      //         <div class='contenido1'>
      //         </div>
      //                                 <p>Gracias por tu compra</p>
      // <div style='color: #000000; font-size: 18px; font-weight: 600; letter-spacing: 0; line-height: 20px; text-align: justify; padding-bottom: 30px'>
      ...
      //                         </div>
      // </div>
      // <center><input type='button' class='button' value='Comprar nuevamente' style=' background-color: #0B3196;
      //     border: none;
      //     color: white;
      //     padding: 15px 32px;
      //     text-align: center;
