...
exports.ordenAbiertaCreadaEmail = async function(order_id)
{
    ...
    const transporter = nodemailer.createTransport({
      ...
      <body>
        ...
        <div class='contenido1'>
              ...
              <p>Tu pedido ya está siendo procesado \nConsulta el detalle del correo para ver los tiempos en que estará disponible o si lo prefieres en la sección de <a href="`+ process.env.STORE_LINK +`/myprofile">Mis Pedidos<a>.</p>
